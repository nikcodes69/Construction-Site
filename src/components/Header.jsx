  ...
  return (
    <header className="bg-black relative">
      <div className="flex justify-between items-center text-lg px-4 sm:px-10 py-4">
        <img src={HeaderImage} alt="Company Logo" className="h-[50px] w-[50px]" />
      ...
      {mobileMenuOpen && (
        <nav className="bg-black text-white py-4 px-6 flex flex-col space-y-4 md:hidden absolute w-full z-50">
          <a href="#" className="hover:text-amber-400 transition-colors py-2 border-b border-gray-800">Home</a>
          <a href="#" className="hover:text-amber-400 transition-colors py-2 border-b border-gray-800">About</a>
          <a href="#" className="hover:text-amber-400 transition-colors py-2 border-b border-gray-800">Services</a>
          <a href="#" className="hover:text-amber-400 transition-colors py-2 border-b border-gray-800">Projects</a>
          <a href="#" className="hover:text-amber-400 transition-colors py-2">Contact</a>
        </nav>
      )}
    </header>
  );
